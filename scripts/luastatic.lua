...
-- Vendored copy of luastatic 0.0.12 (https://github.com/ers35/luastatic).
-- The upstream author placed the source in the public domain
-- ("The author disclaims copyright to this source code.").
--
-- Local modifications:
--   * Cross-platform redirect: replace hardcoded "/dev/null" with `nul` on
--     Windows so the C-compiler probe doesn't fail with
--     "The system cannot find the path specified."
--
-- Re-vendor by copying upstream luastatic and re-applying the patch above.
...
-- Platform-aware sink for redirected output (see C-compiler probe below).
...
if not execute(CC .. " --version 1>" .. DEVNULL .. " 2>" .. DEVNULL) then
